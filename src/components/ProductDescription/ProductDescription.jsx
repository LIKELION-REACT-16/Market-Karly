...
export default function ProductDescription({ className, id, ...rest }) {
  return (
    <section
      id={id}
    ...
    >
      ...
      <article className={classes.descriptionArticle}>
        ...
        <p className={classes.detailDescription}>
          ...
          탱탱쫄면을 선보입니다. 밀가루와 감자 전분을 적절히 배합해 탄력이 좋고,
          입에 넣었을 때는 찰지게 씹히죠. 고추장을 넣어 숙성한 비빔장은
          자연스럽고 깊은 맛을 냅니다. 간단하게 조리해 마지막 한 가닥까지 탱탱한
          식감을 즐겨보세요. 취향에 따라 다양한 고명을 올려 드셔도 좋아요.
        </p>
      </article>
